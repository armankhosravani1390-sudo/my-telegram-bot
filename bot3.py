...
def check_and_ask_join(message):
...
def handle_callbacks(call):
    ...
    if call.data == "founder_news":
        ...
        if user_id in news_mode and news_mode[user_id]:
            ...
            bot.send_message(user_id, "✅ شما وارد حالت خبر شدید. پیام خود را بفرستید.")
        ...
        if user_id in ad_mode and ad_mode[user_id]:
            ...
            bot.send_message(user_id, "✅ شما وارد حالت تبلیغ شدید. پیام خود را بفرستید.")
        bot.answer_callback_query(call.id)
        ...
        btn4 = telebot.types.InlineKeyboardButton("🔙 بازگشت", callback_data="founder_panel")
        markup.add(btn1, btn2, btn3, btn4)
